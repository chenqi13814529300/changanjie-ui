...
export default {
  ...
  data() {
    ...
    let checkStudentUsername = (rule, value, callback) => {
      ...
      this.$API.register
        .checkStudentUsername(this.customerInfo.username)
        .then((res) => {
          if (value === undefined) {
  ...
  methods: {
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        ...
        this.customerInfo.picture = this.customerInfo.picture.join(",");
        console.log(this.customerInfo);
        this.$API.register.studentRegister(this.customerInfo).then((res) => {
          console.log(res);
        });
      });
    },
